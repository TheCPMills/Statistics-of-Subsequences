...
public class Model {
    ...
    public void draw(Shader shader, Camera camera) throws Exception {
        ...
        // meshes.get(choice).draw(shader, camera);
        // if (++iterations % 100 == 0) {
        //     choice = (choice + 1) % meshes.size();
        // }
    }
    ...
    private void parseFile(String fileName) throws Exception {
        ...
        for (Entry<String, Obj> entry : objectGroups.entrySet()) {
            ...
            int lengthIndex = objectName.indexOf("[");
            String materialName = objectName.substring(lengthIndex + 1, objectName.length() - 1);
            ...
            Mesh mesh = constructMesh(objectGroup, material);
            meshes.add(mesh);
        }
